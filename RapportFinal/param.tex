...
\AddEverypageHook{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    {\fontsize{10}{13}\selectfont Compte Rendu Final Conception Circuit Numérique}
    };
  \end{tikzpicture}%
}
...
\AddEverypageHook{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    {\fontsize{10}{13}\selectfont Tony PEAULT \& Nolan BUCHET}
    };
  \end{tikzpicture}%
}
...
\AddEverypageHook{%
  ...
  \begin{tikzpicture}[remember picture, overlay]
    ...
    {\fontsize{10}{13}\selectfont Novembre 2025}
    };
  \end{tikzpicture}%
}
