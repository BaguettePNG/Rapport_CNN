...
% Flèche rouge montrant le processus de conception architecturale vers prototypage
\draw[red, thin] (3.2,3.2) circle (0.5);
\draw[red, thin] (2.2,2.2) circle (0.5);
\draw[red, thick, -latex] (3.2,3.2) -- (2.2,2.2);

\end{tikzpicture}
}
\caption{Diagramme en Y - Conception architecturale vers prototypage}
\label{fig:diagramme_y_prototypage}
\end{figure}
