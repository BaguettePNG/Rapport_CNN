...
% Flèche rouge montrant le processus de conception fonctionnelle vers architecturale
\draw[red, thin] (4.2,4.2) circle (0.5);
\draw[red, thin] (3.2,3.2) circle (0.5);
\draw[red, thick, -latex] (4.2,4.2) -- (3.2,3.2);

\end{tikzpicture}
}
\caption{Diagramme en Y - Conception fonctionnelle vers conception architecturale}
\label{fig:diagramme_y_conception}
\end{figure}
