...
%  \centering
%  \includegraphics[width=0.95\linewidth]{images/Simulation/banc_test.png}
%  \caption{Block Diagramme de test de l’Interface Reception Trame}
%  \label{fig:placeholder}
%\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{images/Simulation/Simu-2.png}
  \caption{Simulation de l’échantillonnage au milieu des bits}
  \label{fig:placeholder}
\end{figure}

L'analyse du chronogramme montre que chaque bit reçu sur la ligne LIN est échantillonné précisément au milieu de sa période.
Cela est confirmé par l'alignement des fronts montants du signal \texttt{NbTbit} avec le milieu de chaque bit sur le signal \texttt{LinSynchro}.
\newline
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{images/Simulation/Simu-3.png}
  \caption{Simulation du stockage des bits dans le registre à décalage}
  \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{images/Simulation/Simu-4.png}
  \caption{Simulation de la réception correcte des octets d'une trame}
  \label{fig:placeholder}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.95\linewidth]{images/Simulation/Simu-6.png}
  \caption{Simulation du comptage/décomptage du nombre d'octets}
  \label{fig:placeholder}
\end{figure}
