...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Synthe/ReceptionTrame_RTL_cropped.pdf}
    \caption{Schéma RTL InterfaceReceptionTrame}
    \label{fig:RTL_Shematic_IRT}
\end{figure}


Dans cette image nous pouvons observer deux blocs correspondant aux deux sous modules de l’Interface Reception Trame, à savoir :
\begin{itemize}
    \item Partie Commande
    \item Partie Opérative
\end{itemize}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Synthe/ReceptionTrameCD_RTL_cropped.pdf}
    \caption{Schéma RTL InterfaceReceptionTrame - Partie Commande}
    \label{fig:RTL_Shematic_IRT}
\end{figure}

Dans cette image nous pouvons observer la partie commande de l’Interface Reception Trame, celui-ci traduit l'automate de commande en VHDL.
\newline

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Synthe/ReceptionTrameOP_RTL_cropped.pdf}
    \caption{Schéma RTL InterfaceReceptionTrame - Partie Opérative}
    \label{fig:RTL_Shematic_IRT}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Synthe/Zoom_1_OP.png}
    \caption{Schéma RTL Zoom 1 - Partie Opérative InterfaceReceptionTrame}
    \label{fig:ZOOM_1_RTL_Shematic_RTL}
\end{figure}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

Et nous retrouvons également le registre de décalage et la bascule :
\newline

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Synthe/Zoom_2_OP.png}
    \caption{Schéma RTL Zoom 2 - Partie Opérative InterfaceReceptionTrame}
    \label{fig:ZOOM_1_RTL_Shematic_RTL}
\end{figure}
...
\begin{figure}[H]
    ...
    \rotatebox{-90}{
        \resizebox{!}{\textwidth}{
            \includegraphics{images/Synthe/FIFO_RTL_cropped.pdf}
        }
    }
...
Nous observons dans ce schéma les différentes portes logiques utilisées pour la conception de cette FIFO.
Surtout, nous pouvons observer les registres utilisés pour le stockage des octets reçus.
\newline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{images/Synthe/EtatInterne_RTL_cropped.pdf}
...
Dans celui ci nous pouvons observer les portes logiques utilisés pour la conception de cette machine.
Nous observons une bascule D qui permet de socket l'EtatLu, comme vu dans la partie TD.
